...
/*
*******************************************************************************
* Function Name  : USB_OTG_IntService
* Description    : usb interrupts service routine
* Arguments      : None
* Return         : None
*******************************************************************************
*/
__attribute__ ((section ("IRQ_HANDLE"))) static void USER_USB_OTG_IntService(void)
{
  #if EN_DEBUG > 0
    //Debug_SysPrint("USER_USB_OTG_IntService\r\n");
  #endif
    //ClearWatchdog();                                                      /* 不在这里加清看门狗，否则U盘升级时无法超时复位 */
               ...
               USBH_Usr_cb_TypeDef *usr_cb)
{
  ...
  NVIC_IrqHandleInstall(OTG_FS_IRQ, (ExecFuncPtr)USER_USB_OTG_IntService, USB_PRIOTITY, true);
