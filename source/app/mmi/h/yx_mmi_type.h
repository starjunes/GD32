...
typedef enum {
    ...
    DN_PE_CMD_HOST_SET_PARA             = 0x46,                /* ÉèÖÃÍ¨ÓÃ²ÎÊý (DOWN) */
    UP_PE_ACK_HOST_SET_PARA             = 0x46,                /* ÉèÖÃÍ¨ÓÃ²ÎÊýÓ¦´ð (UP) */
    
    UP_PE_CMD_SLAVE_GET_PARA            = 0x47,                /* ´Ó»ú²éÑ¯Í¨ÓÃ²ÎÊý */
    DN_PE_ACK_SLAVE_GET_PARA            = 0x47,                /* ´Ó»ú²éÑ¯Í¨ÓÃ²ÎÊýÓ¦´ð */
    
    DN_PE_CMD_CTL_FUNCTION              = 0x48,                /* ¹¦ÄÜ¿ØÖÆ */
    UP_PE_ACK_CTL_FUNCTION              = 0x48,                /* ¹¦ÄÜ¿ØÖÆÓ¦´ð */
    
    DN_PE_CMD_HOST_GET_PARA             = 0x49,                /* Ö÷»ú²éÑ¯Í¨ÓÃ²ÎÊý */
    UP_PE_ACK_HOST_GET_PARA             = 0x49,                /* Ö÷»ú²éÑ¯Í¨ÓÃ²ÎÊýÓ¦´ð */
...
typedef enum {
    ...
    PARA_DEVICEID         = 0x16,                /* Éè±¸ID */
    PARA_SMSPSW           = 0x17,                /* ¶ÌÐÅÃüÁîÃÜÂë */
    PARA_BASE_END,
